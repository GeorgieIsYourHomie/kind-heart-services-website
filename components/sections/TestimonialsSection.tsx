      ...
      <div className="grid grid-rows-[auto_1fr] px-4 md:px-16 py-14 gap-8 md:gap-14">
        <div className="max-w-6xl mx-auto md:text-center">
          <h2 
            ...
            className="text-center text-4xl md:text-5xl text-balance font-serif leading-tight tracking-tight mb-6"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full" role="list" aria-label="Family testimonials">
          {testimonials.map((testimonial, index) => (
            <blockquote key={index} className="not-italic" role="listitem">
